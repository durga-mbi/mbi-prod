    ...
    <tr>
      <td align="center">
        ...
        <table width="100%" cellpadding="0" cellspacing="0"
          style="max-width:400px; background:#eeeeee; border-radius:20px; padding:30px 20px; box-shadow:0 10px 25px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td align="center">
              <h2 style="font-size:18px; color:#222;">
                ${
                  purpose === "signup"
          ...
          <tr>
            <td align="center">
              <div style="background:#fff; padding:20px; border-radius:12px;">
                <p style="font-size:14px; color:#555;">OTP Code</p>
                <h1 style="font-size:30px; letter-spacing:4px;">
                  ${otp}
                </h1>
              </div>
            </td>
...
`;
  ...
  try {
    await transporter.sendMail({
      from: `"MindBotics" <${process.env.EMAIL_USER}>`,
      to: email,
      subject,
      html,
    });
